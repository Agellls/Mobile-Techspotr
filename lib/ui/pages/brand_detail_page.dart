...
class BrandDetailPage extends StatelessWidget {
  ...
  final String brandImageUrl = Get.arguments['brandImageUrl'] ?? '';
  final String brandName = Get.arguments['brandName'] ?? '';
  final int totalProduct = Get.arguments['totalProduct'] ?? 0;
            ...
            child: SizedBox(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    '$brandName its brand selling $totalProduct products',
                    style: blackTextStyle.copyWith(
                      fontSize: 16,
                      fontWeight: regular,
                    ),
